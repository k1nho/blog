...
func (r *Blog) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Blog":
		...
		case "ContainerEcho":
			...
			return (*Blog).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Blog
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Blog).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
